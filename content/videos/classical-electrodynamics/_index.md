  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <div>
        <h3 style="margin-top: 0;">Electrostatic Potential & Field of a Charged Sphere | Spherical Harmonics</h3>
        <p><strong>Description:</strong><br>
        <em>Derivation of the electric potential and field generated by a charged spherical surface by using the powerful method of the spherical harmonics expansion.</em></p>
        <details>
        ...
        Applying this expansion it is remarkably simple to determine the electrostatic potential everywhere in space, then via the negative gradient it follows directly the electric field.
        </div>
        </details>
        </div>
        </div>
        ...
        <p><strong>Description:</strong><br>
        <em>Derivation of the magnetic field produced by a current-carrying circular loop along the z-axis using cylindrical coordinates and vector integration.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <div>
        <h3 style="margin-top: 0;">Electric Field of an Infinite Plane on the z-axis | Vector Method in Polar Coordinates</h3>
        <p><strong>Description:</strong><br>
        <em>In this video, we determine the electric field produced by a uniformly charged infinite plane evaluated along the z-axis using a rigorous vector integration method.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <div>
        <h3 style="margin-top: 0;">Electric Force Between Charged Wires | Continuous Test Charge Distributions</h3>
        <p><strong>Description:</strong><br>
        <em>An approach to calculating the electric force exerted on a continuous test charge distribution, moving beyond standard point-charge problems.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <p><strong>Description:</strong><br>
        <em>A step-by-step determination of the magnetic field generated by an infinite wire carrying a steady current, solved via vector integration.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
