  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <div>
        <h3 style="margin-top: 0;">Motion of a Particle Constrained to a Rotating Plane | Lagrangian & Equation of Motion</h3>
        <p><strong>Description:</strong><br>
        <em>A step-by-step derivation of the equation of motion for a particle constrained to slide along a rotating plane, demonstrating the power of the Lagrangian formulation in non-inertial systems.</em></p>
        <details>
        ...
        <p><strong>Description:</strong><br>
        <em>An intuitive derivation of the escape velocity formula using the conservation of mechanical energy.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <p><strong>Description:</strong><br>
        <em>A comprehensive derivation of the double pendulum system, progressing from the general Lagrangian to the extraction of normal modes of vibration.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <p><strong>Description:</strong><br>
        <em>An analytical solution to the 1D wave equation for a vibrating string, from boundary conditions to the exact series solution using orthogonality.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
        ...
        <p><strong>Description:</strong><br>
        <em>A vector analysis of suspended charged particles, culminating in the analytical resolution of a transcendental equilibrium equation using small-angle approximations.</em></p>
        <details>
        <summary><span style="color:#3b82f6; cursor:pointer; font-weight:bold;">Read full description...</span></summary>
        <div style="margin-top: 10px; font-style: italic; font-size: 0.95rem;">
