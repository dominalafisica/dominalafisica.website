...
sections:
  - block: markdown
    content:
      title: "Quantum Mechanics"
      subtitle: "Wave mechanics, formalism, and advanced quantum systems."
      text: |
        ...
        <div>
        <h3 style="margin-top: 0;">Probabilities and Expectation Values | Quantum Mechanics Foundations</h3>
        <p><strong>Description:</strong><br>
        <em>A clear, step-by-step resolution of a fundamental quantum mechanics problem involving state superposition and energy measurements.</em></p>
        <details>
